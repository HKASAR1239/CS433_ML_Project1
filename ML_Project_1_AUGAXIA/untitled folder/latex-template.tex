...
\begin{tabular}[c]{|l||l|l|l|}
  ...
  Reg. Logistic & 0.4291 &  0.4291 [AICrowd] & $\gamma=0.1$, $\lambda=10^{-6}$ \\
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.8\linewidth]{Log_Reg_F1_VS_gamma.png}
  \captionof{figure}{F1 score vs learning rate gamma for Logistic Regression with 4-fold cross-validation. The optimal gamma of 0.08 balances convergence speed and model performance.}
  \label{fig:log_reg_gamma}
\end{figure}
